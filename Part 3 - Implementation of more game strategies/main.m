...
Strategies = {'All-D', 'All-C', 'Grim', 'TitForTat','Cycle-CDDC','Joss','Swap','Random','Usually-C','Not-forgiving-2'};
% Define the population matrix
Pop = [10, 20, 5, 15, 20, 10, 7, 12, 5, 15]; % Example pop matrix
...
strategyColors = containers.Map( ...
    {'All-D', 'All-C', 'Grim', 'TitForTat','Cycle-CDDC','Joss','Swap','Random','Usually-C','Not-forgiving-2'}, ... % Keys (Strategies)
    {[0.85 0.33 0.10], [0.00 0.45 0.74], [0.47 0.67 0.19], [0.93 0.69 0.13],[0.49, 0.18, 0.56],[0.30, 0.75, 0.93],[0.64, 0.08, 0.18],[0.35, 0.35, 0.35],[0.00, 0.60, 0.50],[0.75, 0.25, 0.75]} ... % Values (Colors)
);
